	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.LayoutControlMenu, group: 'navigation', order: -1, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.LayoutControlMenu, group: 'navigation', order: -2, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
