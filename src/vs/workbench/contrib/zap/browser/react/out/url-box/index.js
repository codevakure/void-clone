...
var mountFnGenerator = (Component) => (rootElement, accessor, props) => {
  ...
  const rerender = (props2) => {
    root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...props2 }));
  };
  const dispose = () => {
    root.unmount();
  };
...
// src/url-box/ZapURLBox.tsx
var import_react10 = __toESM(require_react());

// src/playground/ZapPlayground.tsx
...
// src/styles.css
styleInject(".custom-container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  background-color: #f0f0f0;\n}\n.custom-button {\n  padding: 10px 20px;\n  font-size: 16px;\n  color: white;\n  background-color: #007acc;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n}\n.custom-button:hover {\n  background-color: #005f99;\n}\n.custom-header {\n  font-size: 2rem;\n  color: #007acc;\n  margin-bottom: 20px;\n}\n.zap-playground-wrapper {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--vscode-editor-background);\n  color: var(--vscode-foreground);\n  font-family: var(--vscode-font-family);\n  font-size: var(--vscode-font-size);\n}\n.zap-playground-main {\n  display: flex;\n  flex: 1;\n  overflow: hidden;\n}\n.zap-playground-main-collapsed {\n  display: flex;\n  flex: 1;\n  overflow: hidden;\n}\n.zap-playground-container {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.zap-playground-panel-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 12px 16px;\n  border-bottom: 1px solid var(--vscode-panel-border);\n  background-color: var(--vscode-panel-background);\n  min-height: 40px;\n}\n.zap-playground-title-area {\n  flex: 1;\n}\n.zap-playground-options-area {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.zap-playground-save-options {\n  display: flex;\n  align-items: center;\n}\n.zap-playground-panel-horizontal {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  overflow: hidden;\n}\n.zap-playground-panel-vertical {\n  display: flex;\n  flex-direction: row;\n  flex: 1;\n  overflow: hidden;\n}\n.zap-url-box {\n  border-bottom: 1px solid var(--vscode-panel-border);\n  background-color: var(--vscode-panel-background);\n  padding: 12px 16px;\n}\n.zap-url-input-container {\n  display: flex;\n  align-items: center;\n  gap: 0;\n  border-radius: 4px;\n  overflow: hidden;\n}\n.zap-payload-panel {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  min-height: 0;\n  background-color: var(--vscode-editor-background);\n}\n.zap-method-selector {\n  position: relative;\n  z-index: 100;\n}\n@media (max-width: 768px) {\n  .zap-playground-panel-horizontal {\n    flex-direction: column;\n  }\n  .zap-playground-panel-vertical {\n    flex-direction: column;\n  }\n}\n");

// src/payload-form/ZapPayloadForm.tsx
__toESM(require_react());

// src/payload-form/ZapQueryParamsTable.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());

// src/payload-form/ZapAuthHeaders.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());

// src/payload-form/ZapRequestHeadersTable.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());

// src/payload-form/ZapRequestBody.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());
...
// src/response-viewer/ZapResponseWrapper.tsx
__toESM(require_react());

// src/response-viewer/ZapResponseBody.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());

// src/response-viewer/ZapResponseHeaders.tsx
__toESM(require_react());
__toESM(require_jsx_runtime());
...
// src/response-viewer/ZapResponseViewer.tsx
__toESM(require_jsx_runtime());

// src/playground/ZapPlayground.tsx
__toESM(require_jsx_runtime());
var ZapPlaygroundContext = (0, import_react9.createContext)(void 0);
function useZapPlayground() {
  const context = (0, import_react9.useContext)(ZapPlaygroundContext);
  if (!context) {
...
var AutoGrowInput = ({ value, onChange, placeholder, disabled }) => {
...
function ZapURLBox() {
  ...
  const [urlInputWidth, setUrlInputWidth] = (0, import_react10.useState)("auto");
  const hiddenSpanRef = (0, import_react10.useRef)(null);
    ...
    setTimeout(() => {
      dispatch({
        ...
        payload: {
          ...
          data: { message: "Success", timestamp: (/* @__PURE__ */ new Date()).toISOString() }
        }
      });
    }, 1e3);
  };
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "select",
          {
            ...
            children: HTTP_METHODS.map((method) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: method, children: method }, method))
          }
        ),
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                "span",
                {
                  ...
                  children: state.formData.url || "Enter request URL..."
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            ...
            style: {
              ...
              border: "none",
              borderRadius: "2px",
              backgroundColor: state.formData.url.trim() ? "var(--vscode-button-background)" : "var(--vscode-button-secondaryBackground)",
              color: state.formData.url.trim() ? "var(--vscode-button-foreground)" : "var(--vscode-button-secondaryForeground)",
        ...
        state.formSubmitted && !state.apiResponse && !state.apiError && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "div",
          {
            style: {
              width: "16px",
...
var mountZapURLBox = mountFnGenerator(ZapURLBox);
...
export { ZapURLBox, mountZapURLBox };
